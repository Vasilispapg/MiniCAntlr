...
namespace MiniC
{
    public class CCFile : CComboContainer
    {
        ...
        private CMainFunctionDefinition m_mainDefinition = null;
        public CMainFunctionDefinition MainDefinition => m_mainDefinition;
    ...
    public class CCFunctionDefinition : CComboContainer
    {
        ...
        public CCFunctionDefinition(CEmmitableCodeContainer parent) : base(CodeContainerType.CT_FUNCTION_DEFINITION, parent, 3)
        {
        ...
        public virtual void DeclareVariable(string varname, bool isread)
        {
            ...
            if (!m_localSymbolTable.Contains(varname))
            {
                ...
                else
                {
                    ...
                    CEmmitableCodeContainer compoundst = GetChild(CCFunctionDefinition.mc_BODY);
    ...
    public class CForContainer : CComboContainer
    {
        ...
        public override CodeContainer AssemblyCodeContainer()
        {
            ...
            Console.WriteLine(GetContextChildren(0));
    ...
    public class CFunctionCallContainer : CComboContainer
    {
        public const int mc_NAME = 0, mc_ARGS = 1;
        public readonly String[] mc_contextNames = { "NAME", "ARGS"};

        public CFunctionCallContainer(CEmmitableCodeContainer parent) : base(CodeContainerType.CT_FUNCTION_CALL, parent,
            2)
        { }
    ...
    public class CFunctionDefContainer : CComboContainer
    {
        public const int mc_NAME = 0, mc_ARGS = 1, mc_COMPSTATEMENT=2;
        public readonly String[] mc_contextNames = { "NAME", "ARGS", "CT_COMPSTATEMENT" };

        public CFunctionDefContainer(CEmmitableCodeContainer parent) : base(CodeContainerType.CT_FUNCTION_DEFINITION, parent, 3)
        {
    ...
    {
        CCompoundContainer m_compound;

        public CMainFunctionDefinition(CComboContainer parent) : base(parent)
        {
            m_compound = new CCompoundContainer(this);
            string mainheader = "\nvoid main(int argc, char* argv[])";
            AddCode(mainheader, CCFunctionDefinition.mc_HEADER);
            AddCode(m_compound, CCFunctionDefinition.mc_BODY);
        }
    }
}
